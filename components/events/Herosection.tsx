...
import { Calendar, ArrowRight, Sparkles, Users, Zap, Globe, TrendingUp } from 'lucide-react';
...
function ParticleCanvas() {
  ...
  useEffect(() => {
    ...
    const particles: {
      ...
      r: number; o: number; color: string;
    }[] = [];
...
function TypewriterText({ words }: { words: string[] }) {
  ...
  return (
    <span className="gradient-text text-glow-p">
      {displayed}
      <span className="animate-[blinkCursor_0.7s_step-end_infinite] border-r-[3px] border-[var(--primary)] ml-0.5">
        &nbsp;
      </span>
    </span>
  );
  ...
  return (
    <div className="card overflow-hidden animate-pulse">
      ...
      <div className="p-5 space-y-3">
        ...
        <div className="h-10 bg-[var(--surface-2)] rounded-xl mt-4" />
      </div>
    </div>
  );
}
...
export default function HeroSection() {
  ...
  useEffect(() => {
    api.get('/events/featured')
      .then((r) => setFeatured(r.data.event))
      .catch(() => {})
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              >
                ...
                happen in real time — with instant notifications, live participant counts, and
                seamless payments.
              </motion.p>
              ...
              >
                <div className="flex -space-x-3">
                  {['#8B5CF6', '#22D3EE', '#10B981', '#F59E0B', '#EF4444'].map((c, i) => (
                    <div
                      key={i}
                      className="w-9 h-9 rounded-full border-2 border-[var(--bg)] flex items-center justify-center text-xs font-bold text-white"
                      style={{ background: c }}
                    >
                      {['A', 'B', 'C', 'D', 'E'][i]}
                    </div>
            ...
            {/* Right — Featured EventCard + floating chips */}
            <motion.div
            ...
            >
              ...
              <div className="absolute inset-0 rounded-2xl bg-[var(--primary)]/10 blur-2xl scale-95 pointer-events-none" />

              {/* Featured EventCard — floats gently */}
              <motion.div
                animate={{ y: [0, -8, 0] }}
              ...
              >
                {loading ? (
                  ...
                  /* Real EventCard — reuses all its badges, image, rating, live count */
                  <EventCard event={featured} index={0} />
                ) : (
                  /* Fallback placeholder card */
                  <div className="card overflow-hidden animate-border-glow shadow-2xl">
              ...
              <motion.div
                ...
                className="absolute -bottom-6 -left-6 z-20 card p-4 w-48 shadow-xl"
              >
              ...
              {/* Floating chip — Live events */}
              <motion.div
                animate={{ y: [0, -10, 0] }}
                transition={{ duration: 6, repeat: Infinity, ease: 'easeInOut', delay: 2 }}
                className="absolute -bottom-6 -right-6 z-20 card p-4 w-44 shadow-xl"
              >
